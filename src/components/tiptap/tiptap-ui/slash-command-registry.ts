...
export const registerSlashCommand = (item: SlashCommandItem) => slashCommandRegistry.register(item)
export const unregisterSlashCommand = (title: string) => slashCommandRegistry.unregister(title)
export const getSlashCommands = () => slashCommandRegistry.getItems()
export const searchSlashCommands = (query: string) => slashCommandRegistry.search(query)